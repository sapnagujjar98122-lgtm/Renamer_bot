...
user_sessions = {}            # user_id -> {"mode":"normal/huge_upload/add_channel"}
...
async def video_handler(client,message):
    ...
    # skip if user in huge_upload / add_channel session
    session = user_sessions.get(user_id, {}).get("mode", "normal")
    if session in ["huge_upload", "add_channel"]:
        return
